...
import { WiringEditor } from './components/WiringEditor';
import { PCBViewer } from './components/PCBViewer';
import { OverviewBlock } from './components/OverviewBlock';
import { BOMBlock } from './components/BOMBlock';
import { AssemblyBlock } from './components/AssemblyBlock';
import { DRCBlock } from './components/DRCBlock';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const isDark = activeTheme !== 'engineering-paper';
